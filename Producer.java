package com.apachemq.example;

/*
 * Followed the example from here: 
...
public class Producer {
	...
	private static String subject = "ApacheMQExample"; // Queue Name
	...
	public static void main(String[] args) throws JMSException {
		...
		TextMessage message = session.createTextMessage("Hello Pavan, you're now boarding an ActiveMQ Queue!");
